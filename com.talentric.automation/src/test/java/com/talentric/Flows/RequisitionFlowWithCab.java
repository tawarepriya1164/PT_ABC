...
public class RequisitionFlowWithCab {
	...
	public void TalentricNewRequisition(WebDriver driver, String TC_ID) throws Throwable {
		try {
			...
			if(method.checkElementDisplayedBy(driver, TalentricHomePage_Locators.NewRequisition_Button)) {
				System.out.println("New Requisition created successfully with cab facility..");
			}
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	public void TalentricNewRequisitionWithCabFacility(WebDriver driver, String TC_ID) throws Throwable {
		try {
			Thread.sleep(6000);
			WebDriverWait wait = new WebDriverWait(driver,30);
			...
			String cabCommentErrorMsg = Excel_Handling.Get_Data(TC_ID, "cabCommentErrorMsg");
			String errorMessage = method.getInputTextValue(driver, TalentricNewRequisitionPage_Locators.cabCommentError, "Error message");
			
			if(cabCommentErrorMsg.equals(errorMessage)) {
				System.out.println("Verified Project Manager cannot add the New Requisition with \"Cab Facility\" and without \"Special comments\"");
			}
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	public void TalentricNewRequisitionWithoutJobLocation(WebDriver driver, String TC_ID) throws Throwable {
		try {
			Thread.sleep(6000);
			WebDriverWait wait = new WebDriverWait(driver,30);
			...
			String jobLocationErrorMsg = Excel_Handling.Get_Data(TC_ID, "jobLocationErrorMsg");
			String errorMessage = method.getInputTextValue(driver, TalentricNewRequisitionPage_Locators.jobLocationError, "Error message");
			
			if(jobLocationErrorMsg.equals(errorMessage)) {
				System.out.println("Verified Project Manager cannot add new Requisition except Job Location.");
			}
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	public void TalentricNewRequisitionWithoutNoOPositions(WebDriver driver, String TC_ID) throws Throwable {
		try {
			Thread.sleep(6000);
			WebDriverWait wait = new WebDriverWait(driver,30);
			...
			String jobLocationErrorMsg = Excel_Handling.Get_Data(TC_ID, "NoOfPositionsErrorMsg");
			String errorMessage = method.getInputTextValue(driver, TalentricNewRequisitionPage_Locators.noOfPositionsError, "Error message");
			
			if(jobLocationErrorMsg.equals(errorMessage)) {
				System.out.println("Verified Project Manager cannot add new Requisition except No Of Positions.");
			}
		}
		catch(Exception e) {
			e.printStackTrace();
	...
	public void TalentricNewRequisitionWithJobResponsibilitiesLessThan200Char(WebDriver driver, String TC_ID) throws Throwable {
		try {
			Thread.sleep(6000);
			WebDriverWait wait = new WebDriverWait(driver,30);
			...
			String JobResponsibilitiesErrorMsg = Excel_Handling.Get_Data(TC_ID, "JobResponsibilitiesErrorMsg");
			String errorMessage = method.getInputTextValue(driver, TalentricNewRequisitionPage_Locators.jobResponsibilitiesError, "Error message");
			System.out.println("JobResponsibilitiesErrorMsg" + JobResponsibilitiesErrorMsg);
			System.out.println("errorMessage" + errorMessage);
			
			if(JobResponsibilitiesErrorMsg.equals(errorMessage)) {
				System.out.println("Verified the Project Manager can add the new Requisition with Job Responsibilities less than 200 charecter.");
			}
		}
		catch(Exception e) {
			e.printStackTrace();
